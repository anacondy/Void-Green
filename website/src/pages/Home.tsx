  ...
  return (
    <div style={{ background: '#000', minHeight: '100vh', overflow: 'hidden' }}>
      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{ borderColor: 'rgba(71,255,204,0.3)', color: '#a8f0e0' }}
          >
            ENTER VOID.GAME
          </button>
        </motion.div>
      ...
      <section style={{ padding: '4rem 2rem 6rem', maxWidth: '900px', margin: '0 auto' }}>
        ...
        >
          {[
            { num: '01', title: 'ARCHIVE', sub: 'Explore our catalogue of digital works and experiments.', path: '/archive' },
            { num: '02', title: 'LAB', sub: 'Interactive tools, generators, and creative experiments.', path: '/lab' },
            { num: '03', title: 'VOID.GAME', sub: 'A fully playable game embedded within the experience.', path: '/game' },
          ].map((card, cardIdx) => (
            <motion.div
              key={card.num}
